...
): Middleware<LiftedState, LiftedAction> = Middleware { getState, action, next ->
...
): Middleware<KeyedState, KeyedAction> = Middleware { getState, action, next ->
...
): Middleware<IndexedState, IndexedAction> = Middleware { getState, action, next ->
